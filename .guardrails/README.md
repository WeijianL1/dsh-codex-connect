...
GitHub Dependency Review does not support forks. On forks its workflow runs
a full pnpm dependency audit instead, failing on high/critical advisories or
audit errors. Non-forks retain the upstream dependency-review action. The fork
audit includes development dependencies and is not a differential review.
